{'type': 'dancer', 'dancer': 
{'id': 13412, 'first_name': 'JD', 'last_name': 'Nafziger', 'wscid': 13758}, 'level': {'required': 'ADV', 'allowed': 'ADV', 'reason': ''}, 
    'placements': {'West Coast Swing': 
    {'ADV': {'division': {'id': 6, 'name': 'Advanced', 'abbreviation': 'ADV'}, 'total_points': 27, 'competitions': 
    ...
    'INT': {'division': {'id': 5, 'name': 'Intermediate', 'abbreviation': 'INT'}, 'total_points': 36, 'competitions': 
        ...
        {'role': 'leader', 'points': 1, 'event': {'id': 76, 'name': 'Michigan Dance Classic', 'location': 'Dearborn, MI', 'url': '', 'date': 'June 2018'}, 'result': 'F'}, {'role': 'leader', 'points': 10, 'event': {'id': 242, 'name': 'Derby City Swing', 'location': 'Louisville, KY', 'url': '', 'date': 'January 2018'}, 'result': '1'}]}, 
    'NOV': {'division': {'id': 4, 'name': 'Novice', 'abbreviation': 'NOV'}, 'total_points': 17, 'competitions': 
    ...
    'NEW': {'division': {'id': 3, 'name': 'Newcomer', 'abbreviation': 'NEW'}, 'total_points': 6, 'competitions': 
